...
from .speaker_model import DEFAULT_SPEAKER_MODEL, predict_speaker
...
app.config["SPEAKER_MODEL_PATH"] = BASE_DIR / DEFAULT_SPEAKER_MODEL
...
def run_inference(audio_path: Path, mode: str, whisper_model: str = DEFAULT_MODEL):
    speaker_prediction = predict_speaker(audio_path, model_path=app.config["SPEAKER_MODEL_PATH"])
    ...
    if mode == "trained":
        ...
        payload.update(speaker_prediction)
        return payload
